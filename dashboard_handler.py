...
class DashboardHandler:
    ...
    SEND_TO_DASHBOARD_COMMAND = "sshpass -f {ssh_pass_file_name} scp -P {connection_port} -o StrictHostKeyChecking=no -pr {images_folder_directory} {dashboard_host_name}@{dashboard_host_ip}:{dashboard_images_saving_directory}"
    ...
    def send_image_to_dashboard(self, local_images_saving_directory):
